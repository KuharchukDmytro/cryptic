...
import { getCorrectNavigationLink } from '@/utils/core/getCorrectNavigationLink';
...
export const ConversationItem: FC<Props> = ({ id, participants, messages }) => {
  ...
  return (
    <Link to={getCorrectNavigationLink(AppRoutes.CONVERSATION, ':id', id)}>
      <FlexContainer
        direction='row'
        align='center'
        gap={8}
      ...
      >
        ...
        <FlexContainer>
          <h5 className={styles.conversation_item__username}>
            {other.username}
          </h5>
